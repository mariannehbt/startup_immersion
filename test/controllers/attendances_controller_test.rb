...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { comment: @attendance.comment, motivation: @attendance.motivation } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { comment: @attendance.comment, motivation: @attendance.motivation } }
